...
namespace vm {
	...
	struct Image
	{
		...
		void transitionImageLayout(const vk::CommandBuffer cmd, const vk::ImageLayout oldLayout, const vk::ImageLayout newLayout, const vk::PipelineStageFlags oldStageMask, const vk::PipelineStageFlags newStageMask, const vk::ImageAspectFlags aspectFlags = vk::ImageAspectFlagBits::eColor);
