#include "Renderer/Downsampler/Downsampler.h"
...
namespace pe
{
    ...
    void Downsampler::UpdatePassInfo()
    {
        ...
        s_passInfo->pCompShader = Shader::Create(Path::Assets + "Shaders/spd/spd.hlsl", ShaderStage::ComputeBit, defines, ShaderCodeType::HLSL);
