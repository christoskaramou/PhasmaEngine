...
constexpr PeBufferUsageFlags PE_BUFFER_USAGE_RESOURCE_DESCRIPTOR_BUFFER = 1ULL << 11;
constexpr PeBufferUsageFlags PE_BUFFER_USAGE_SAMPLER_DESCRIPTOR_BUFFER = 1ULL << 12;
constexpr uint32_t PE_BUFFER_USAGE_BIT_COUNT = 13;
