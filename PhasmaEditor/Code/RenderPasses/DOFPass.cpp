...
namespace pe
{
    ...
    void DOFPass::UpdatePassInfo()
    {
        ...
        m_passInfo->pFragShader = Shader::Create({.sourcePath = Path::Assets + "Shaders/DepthOfField/DOFPS.hlsl", .entryPoint = "mainPS", .stage = PE_SHADER_STAGE_FRAGMENT, .defines = std::vector<Define>{}});
