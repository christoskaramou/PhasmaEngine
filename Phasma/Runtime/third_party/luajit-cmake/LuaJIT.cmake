...
if(NOT CMAKE_CROSSCOMPILING)
  ...
  # Phasma patch: LUAJIT_HOST_CMAKE_ARGS lets the parent project supply an
  # explicit host generator/compiler (gradle/NDK environments have none on PATH).
  add_custom_command(OUTPUT ${MINILUA_PATH}
    COMMAND ${CMAKE_COMMAND} ${TOOLCHAIN} ${TARGET_SYS} ${LUAJIT_HOST_CMAKE_ARGS}
...
if(NOT CMAKE_CROSSCOMPILING)
  ...
  # Phasma patch: see minilua above.
