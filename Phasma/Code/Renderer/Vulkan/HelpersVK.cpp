namespace pe
{
    ...
    static std::unordered_map<uint64_t, Format> s_translatorPeFormat{
    ...
    static std::unordered_map<uint64_t, ColorSpace> s_translatorPeColorSpace{
    ...
    static std::unordered_map<uint64_t, PresentMode> s_translatorPePresentMode{
    ...
    static uint64_t s_translatorShaderStage[]{
    ...
    static uint64_t s_translatorFilter[]{
        VK_FILTER_NEAREST,
        VK_FILTER_LINEAR,
        VK_FILTER_CUBIC_IMG};

    static uint64_t s_translatorImageAspect[]{
        VK_IMAGE_ASPECT_COLOR_BIT,
        VK_IMAGE_ASPECT_DEPTH_BIT,
        VK_IMAGE_ASPECT_STENCIL_BIT};

    static uint64_t s_translatorSamplerMipmapMode[]{
        VK_SAMPLER_MIPMAP_MODE_NEAREST,
        VK_SAMPLER_MIPMAP_MODE_LINEAR};

    static uint64_t s_translatorSamplerAddressMode[]{
    ...
    static uint64_t s_translatorCompareOp[]{
        VK_COMPARE_OP_NEVER,
        VK_COMPARE_OP_LESS,
        VK_COMPARE_OP_EQUAL,
    ...
    static uint64_t s_translatorBorderColor[]{
    ...
    static uint64_t s_translatorImageType[]{
        VK_IMAGE_TYPE_1D,
        VK_IMAGE_TYPE_2D,
        VK_IMAGE_TYPE_3D};

    static uint64_t s_translatorImageViewType[]{
    ...
    static uint64_t s_translatorSampleCount[]{
    ...
    static uint64_t s_translatorFormat[]{
        VK_FORMAT_UNDEFINED,
        VK_FORMAT_R8_SINT,
        VK_FORMAT_R8_UINT,
        VK_FORMAT_R8_UNORM,
    ...
    static uint64_t s_translatorImageTiling[] = {
        VK_IMAGE_TILING_OPTIMAL,
        VK_IMAGE_TILING_LINEAR};

    static uint64_t s_translatorImageUsageFlags[] = {
    ...
    static uint64_t s_translatorSharingMode[] = {
        VK_SHARING_MODE_EXCLUSIVE,
        VK_SHARING_MODE_CONCURRENT};

    static uint64_t s_translatorImageCreateFlags[] = {
    ...
    static uint64_t s_translatorCommandBufferUsageFlags[] = {
        VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT,
        VK_COMMAND_BUFFER_USAGE_RENDER_PASS_CONTINUE_BIT,
        VK_COMMAND_BUFFER_USAGE_SIMULTANEOUS_USE_BIT};

    static uint64_t s_translatorBufferUsageFlags[]{
    ...
    static uint64_t s_translatorColorSpace[]{
    ...
    static uint64_t s_translatorPresentMode[]{
    ...
    static uint64_t s_translatorAttachmentLoadOp[]{
        VK_ATTACHMENT_LOAD_OP_LOAD,
        VK_ATTACHMENT_LOAD_OP_CLEAR,
        VK_ATTACHMENT_LOAD_OP_DONT_CARE};

    static uint64_t s_translatorAttachmentStoreOp[]{
        VK_ATTACHMENT_STORE_OP_STORE,
        VK_ATTACHMENT_STORE_OP_DONT_CARE};

    static uint64_t s_translatorAccessFlags[]{
        VK_ACCESS_2_NONE,
    ...
    static uint64_t s_translatorAllocationCreateFlags[]{
        0,
    ...
    static uint64_t s_translatorBlendFactor[]{
    ...
    static uint64_t s_translatorBlendOp[]{
        VK_BLEND_OP_ADD,
    ...
    static uint64_t s_translatorColorComponentFlags[]{
        VK_COLOR_COMPONENT_R_BIT,
        VK_COLOR_COMPONENT_G_BIT,
        VK_COLOR_COMPONENT_B_BIT,
        VK_COLOR_COMPONENT_A_BIT};

    static uint64_t s_translatorDynamicState[]{
    ...
    static uint64_t s_translatorDescriptorType[]{
    ...
    static uint64_t s_translatorCullMode[]{
        VK_CULL_MODE_NONE,
        VK_CULL_MODE_FRONT_BIT,
        VK_CULL_MODE_BACK_BIT,
        VK_CULL_MODE_FRONT_AND_BACK};

    static uint64_t s_translatorObjectType[]{
    ...
    static uint64_t s_translatorVertexInputRate[]{
        VK_VERTEX_INPUT_RATE_VERTEX,
        VK_VERTEX_INPUT_RATE_INSTANCE};

    static uint64_t s_translatorAttachmentDescriptionFlags[]{
        VK_ATTACHMENT_DESCRIPTION_MAY_ALIAS_BIT};

    static uint64_t s_translatorCommandPoolCreateFlags[]{
        VK_COMMAND_POOL_CREATE_TRANSIENT_BIT,
        VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT,
        VK_COMMAND_POOL_CREATE_PROTECTED_BIT};

    static uint64_t s_translatorPrimitiveTopology[]{
    ...
    static uint64_t s_translatorPolygonMode[]{
        VK_POLYGON_MODE_FILL,
        VK_POLYGON_MODE_LINE,
        VK_POLYGON_MODE_POINT};

    static uint64_t s_translatorStencilOp[]{
        VK_STENCIL_OP_KEEP,
        VK_STENCIL_OP_ZERO,
    ...
    template <>
    VkImageUsageFlags Translate(ImageUsage value) { return Translate<VkImageAspectFlags, ImageUsageFlags>(value); }
