...
namespace pe
{
    ...
    void FXAAPass::UpdatePassInfo()
    {
        ...
        m_passInfo->pFragShader = Shader::Create(Path::Executable + "Assets/Shaders/FXAA/FXAAPS.hlsl", ShaderStage::FragmentBit, "mainPS", std::vector<Define>{}, ShaderCodeType::HLSL);
