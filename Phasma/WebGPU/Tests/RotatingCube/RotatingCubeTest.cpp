...
namespace
{
    ...
    class RotatingCubeSample final : public pwgpu::test::SampleBase
    {
    public:
    ...
    pwgpu::test::SampleAppDesc MakeRotatingCubeDesc()
    {
...
{
    RotatingCubeSample sample;
    pwgpu::test::SampleApp app(sample, MakeRotatingCubeDesc());
